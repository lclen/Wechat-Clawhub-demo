...
class LauncherRuntimeModelTests(unittest.TestCase):
    def test_gateway_role_disables_local_node(self) -> None:
    ...
    def test_gateway_start_request_does_not_restore_builtin_local_node(self) -> None:
        ...
        self.assertFalse(updated.enable_local_node)
        self.assertTrue(runtime.gateway_should_run)
        self.assertFalse(runtime.local_node_should_run)
        self.assertEqual(runtime.machine_role, LauncherMachineRole.GATEWAY)

    def test_gateway_console_role_runs_builtin_local_node(self) -> None:
        profile = apply_machine_role(LauncherProfile(), LauncherMachineRole.GATEWAY_CONSOLE)
        ...
        self.assertEqual(runtime.machine_role, LauncherMachineRole.GATEWAY_CONSOLE)
