...
export type LocalNodeChannelAssessmentRound = { round_index: number; max_concurrency: number; channel_capacity: number; request_count: number; success_count: number; failure_count: number; timeout_count: number; success_rate: number; average_latency_ms: number; max_latency_ms: number; stable: boolean; stop_reason: string; summary: string };
