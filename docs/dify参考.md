...
POST
/chat-messages
curl -X POST 'http://121.41.47.90:3000/v1/chat-messages' \
...
POST
/files/upload
curl -X POST 'http://121.41.47.90:3000/v1/files/upload' \
--header 'Authorization: Bearer {api_key}' \
...
GET
/files/:file_id/preview
curl -X GET 'http://121.41.47.90:3000/v1/files/72fa9618-8f89-4a37-9b33-7e1178a24a67/preview' \
--header 'Authorization: Bearer {api_key}'
...
curl -X GET 'http://121.41.47.90:3000/v1/files/72fa9618-8f89-4a37-9b33-7e1178a24a67/preview?as_attachment=true' \
--header 'Authorization: Bearer {api_key}' \
...
POST
/chat-messages/:task_id/stop
curl -X POST 'http://121.41.47.90:3000/v1/chat-messages/:task_id/stop' \
...
POST
/messages/:message_id/feedbacks
curl -X POST 'http://121.41.47.90:3000/v1/messages/:message_id/feedbacks \
--header 'Authorization: Bearer {api_key}' \
--header 'Content-Type: application/json' \
--data-raw '{
  "rating": "like",
...
GET
/app/feedbacks
curl -X GET 'http://121.41.47.90:3000/v1/app/feedbacks?page=1&limit=20'
...
GET
/messages/{message_id}/suggested
curl --location --request GET 'http://121.41.47.90:3000/v1/messages/{message_id}/suggested?user=abc-123 \
...
GET
/messages
curl -X GET 'http://121.41.47.90:3000/v1/messages?user=abc-123&conversation_id=' \
--header 'Authorization: Bearer {api_key}'
...
GET
/conversations
curl -X GET 'http://121.41.47.90:3000/v1/conversations?user=abc-123&last_id=&limit=20'\
--header 'Authorization: Bearer {api_key}'
